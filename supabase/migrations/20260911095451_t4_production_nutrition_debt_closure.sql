-- F2 Recipe Automation — T4: production nutrition debt closure (verified draft PR #126, orchestrator-applied
-- 2026-09-11 per Berkin's explicit takeover authorization; branch codex/t4-production-nutrition-debt-closure,
-- commits 30387a8 + 2cc4092). See claude/T4-Nutrition-Debt-Closure-Onay-ve-Uygulama-2026-09-11.md for full
-- decision record (D01-D38) and independent verification notes.
...
create table public.recipe_ingredient_nutrition_backfill_audit (
  ...
  created_at timestamptz not null default now(),
  unique (migration_key, ingredient_id)
);
