...
5. Ardından özellikle çıkış yapıldığında açılan `/` tanıtım sayfasının sadeleştirme değerlendirmesine geri dön; tamamlanan ürün akışı ve tekrar analizini kullanarak seçenekleri sun.
