...
import cancelSubscriptionTool from "./tools/cancel-subscription";
...
export default defineMcp({
  ...
  instructions:
    ...
    "Buyer tools: discover listings (browse_marketplace), submit / negotiate / pay for offers (create_offer, respond_to_counter, list_my_offers, mark_transfer_sent, list_my_orders), and manage harvest subscriptions (create_subscription, list_my_subscriptions, cancel_subscription). " +
    "Community: create_community_post, list_community_posts. " +
    "Shared: list_pending_offers. " +
    "Sensitive tools (respond_to_offer, respond_to_counter, confirm_payment_received, mark_transfer_sent, create_subscription, cancel_subscription) require an explicit confirm=true flag because their effects are not reversible via MCP.",
